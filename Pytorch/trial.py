...
def s_y(s_x):
    noise = np.random.uniform(0, 1, size=N_TRUE_SAMPLES)[:, np.newaxis]
    # s_y = -np.random.rand() * (3.1 * s_x + 1.7 * s_x ** 2 - 11.6 * s_x ** 5)
    # s_y = -2*np.random.rand() + (3.1 * s_x + 1.7 * s_x ** 2 - 11.6 * s_x ** 5)
    s_y = s_x**2 + noise
    return s_y
